...
public class GvrTouchPoint : GvrBaseControllerVisual {
  ...
  void Awake() { 
    ...
    if (GvrController.IsTouching) {
      ...
      Vector3 minimovement = (GameObject.FindGameObjectWithTag("MainCamera").transform.rotation*new Vector3(x, 0, -y)).normalized;
      Vector3 movement = new Vector3(minimovement.x, 0, minimovement.z) * 0.5f;
      GameObject.FindGameObjectWithTag("Player").transform.position += movement * 0.5f;
